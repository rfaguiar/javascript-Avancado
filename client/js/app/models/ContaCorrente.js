    ...
    return {
        ...
        execute: function () {
            ...
            ContaCorrente = function (_Conta) {
                ...
                function ContaCorrente(titular, conta) {
                    _classCallCheck(this, ContaCorrente);

                    return _possibleConstructorReturn(this, (ContaCorrente.__proto__ || Object.getPrototypeOf(ContaCorrente)).call(this, titular, conta));
                }
